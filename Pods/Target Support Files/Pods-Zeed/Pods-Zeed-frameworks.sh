...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Zendesk/ZendeskSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ZendeskSDKConversationKit/ZendeskSDKConversationKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ZendeskSDKFayeClient/ZendeskSDKFayeClient.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ZendeskSDKHTTPClient/ZendeskSDKHTTPClient.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ZendeskSDKLogger/ZendeskSDKLogger.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ZendeskSDKMessaging/ZendeskSDKMessaging.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ZendeskSDKSocketClient/ZendeskSDKSocketClient.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ZendeskSDKStorage/ZendeskSDKStorage.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ZendeskSDKUIComponents/ZendeskSDKUIComponents.framework"
fi
